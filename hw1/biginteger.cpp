...
BigInteger BigInteger::Add(const BigInteger &num1, const BigInteger &num2,
                           int32_t sign) {
    BigInteger temp;
    temp.sign_ = sign;
...
BigInteger BigInteger::Sub(BigInteger num1, BigInteger num2, int32_t sign) {
    ...
    for (size_t i = 0; i < size; ++i) {
        now +=
                (int64_t) vector_at(num1.data_, i) - (int64_t) vector_at(num2.data_, i);
        if (now < 0) {
...
BigInteger::BigDivMod(const BigInteger &numerator,
...
std::pair<BigInteger, BigInteger>
BigInteger::DivMod(const BigInteger &numerator, const BigInteger &denominator) {
...
BigInteger::BigInteger(const BigInteger &num) { *this = num; }

BigInteger::BigInteger(const int64_t &num) { *this = num; }
...
BigInteger::operator bool() { return !(*this == BigInteger(0)); }
...
int32_t BigInteger::GetSign() const { return sign_; }
...
void swap(BigInteger &num1, BigInteger &num2) { num1.Swap(num2); }
